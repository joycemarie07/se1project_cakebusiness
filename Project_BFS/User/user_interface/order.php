...
$insert_orders="Insert into `user_orders` (user_id,due_amount,invoice_number,total_orders,order_date,order_status) values($user_id,$subtotal,$invoice_number,$count_product,NOW(),'$status')";
