...
<input type="password"placeholder="Confirm Password" class="form-control confirm" id="con_pass" required>
...
<input type="text" class="form-control" value="Phillipines" name="c_country" readonly required>
...
<input type="text" class="form-control" name="c_contact" value="+63" maxlength="13" onkeydown="return ValidateInput(this);"required>
<script>
        function ValidateInput(ctrl) {
            if (event.keyCode == 8 ||event.keyCode == 46) {   //backspace pressed or delete key pressed
                ...
                if (ctrl.selectionStart <= 3) return false;
            }
...
<input type="text" class="form-control" name="c_address" placeholder="House No., St. Barangay"required>
