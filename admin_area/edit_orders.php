...
$edit_orders = "select * from customer_orders where order_id='$edit_id'";

$run_edit = mysqli_query($con,$edit_orders);
...
<input type="text" name="cat_title" class="form-control" value="<?php echo $c_id; ?>">
