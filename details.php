...
$query = "insert into cart (p_id,ip_add,qty,p_price,size,cake_label,flavor,date_need) values ('$p_id','$ip_add','$product_qty','$product_price','$product_size','$cake_label','$flavor','$date_need')";
...
<br>
Small: 6 inches | 12 Servings <br>
Meduim: 10 inches | 28 Servings <br>
Large: 16 inches | 77 Servings<br>
</div><!-- col-md-7 Ends -->
...
<label class="col-md-5 control-label" >Cake Flavor</label>
...
<label class="col-md-5 control-label" >Text on Cake</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<input type="text" name="cake_label" class="form-control" required >
...
<label class="col-md-5 control-label" >Date Needed</label>

<div class="col-md-7" ><!-- col-md-7 Starts -->

<input type="date" name="date_need"
       value="2022-05-24"
       min="2022-05-24" max="2023-12-31" class="form-control" required>
...
<p class='price' > $product_price $product_psp_price </br> Stocks: $pro_stock</p>
